	...
	const debugData: Array<UserWord> = [
		{
			...
			spell: "andra", 
			pronunciation: "[andra]", 
			meaning: "secondandra klass second class (on a train etc.)på andra våningen on the first/ (AmE) second floor", 
		...
		},
		{
			...
			spell: "mer", 
			pronunciation: "[meːr]", 
			meaning: "morealdrig mer never moreinte mer not anymoremer än en more than onemer eller mindre more or lessVad mer? What else?", 
